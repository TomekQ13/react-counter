...
export default function RecipeEdit({ recipe }) {
    const {handleRecipeChange, handleRecipeSelect} = useContext(RecipeContex)
    ...
    return (
        <div className="recipe-edit">
            ...
            <div className="recipe-edit__details-grid">
                ...
                <input type="number" name="servings" id="servings" className="recipe-edit__input" value={recipe.servings}
